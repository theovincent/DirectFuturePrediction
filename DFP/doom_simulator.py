...
# vizdoom_path = "/home/developer/LearningToAct/ViZDoom"
...
class DoomSimulator:
    def __init__(self, args):
        ...
        self._game.set_vizdoom_path(
            "/home/developer/LearningToAct/DirectFuturePrediction/env_container/lib/python3.6/site-packages/vizdoom/vizdoom"
        )
        self._game.set_doom_game_path(
            "/home/developer/LearningToAct/DirectFuturePrediction/env_container/lib/python3.6/site-packages/vizdoom/freedoom2.wad"
        )
    ...
    def step(self, action=0):
        ...
        if term:
            ...
            img = np.zeros(
                (self.num_channels, self.resolution[1], self.resolution[0]), dtype=np.uint8
    ...
    def get_random_action(self):
        return [(random.random() >= 0.5) for i in range(self.num_buttons)]
